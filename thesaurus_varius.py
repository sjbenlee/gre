...
with open('gre2020-thesaurus-hyper.csv') as f:
...
def save_words(words):
	...
	with open('gre2020-thesaurus-var.csv', 'w') as f:
...
for i, r in enumerate(words):
	...
	try:
		...
		various = s.find('span', id='Various')
		ls = various.findParent().fetchNextSiblings()[0].findAll('li')
		for l in ls:
			variouss.append(l.text)
